...
namespace CodeBrix.Imaging.PixelFormats; //Was previously: namespace SixLabors.ImageSharp.PixelFormats;
...
public partial struct Short4 : IPixel<Short4>, IPackedVector<ulong>
{
    ...
    private static ulong Pack(ref Vector4 vector)
    {
        ...
        var word4 = ((ulong)Convert.ToInt32(Math.Round(vector.X)) & 0xFFFF) << 0x00;
        var word3 = ((ulong)Convert.ToInt32(Math.Round(vector.Y)) & 0xFFFF) << 0x10;
        var word2 = ((ulong)Convert.ToInt32(Math.Round(vector.Z)) & 0xFFFF) << 0x20;
        var word1 = ((ulong)Convert.ToInt32(Math.Round(vector.W)) & 0xFFFF) << 0x30;
