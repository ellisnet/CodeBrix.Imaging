    ...
    where TPixel : unmanaged, IPixel<TPixel>
{
    ...
    /// <param name="expectedFormat">The expected format of the image.</param>
    public Image(Configuration configuration, int width, int height, IImageFormat expectedFormat = null)
    ...
    /// <param name="expectedFormat">The expected format of the image.</param>
    public Image(Configuration configuration, int width, int height, TPixel backgroundColor, IImageFormat expectedFormat = null)
    ...
    /// <param name="backgroundColor">The color to initialize the pixels with.</param>
    /// <param name="expectedFormat">The expected format of the image.</param>
    public Image(int width, int height, TPixel backgroundColor, IImageFormat expectedFormat = null)
