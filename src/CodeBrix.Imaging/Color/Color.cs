...
public readonly partial struct Color : IEquatable<Color>
{
    ...
    /// </summary>
    public ushort R => data.R;

    /// <summary>
    /// Gets the green component.
    /// </summary>
    public ushort G => data.G;

    /// <summary>
    /// Gets the blue component.
    /// </summary>
    public ushort B => data.B;

    /// <summary>
    /// Gets the alpha component.
    /// </summary>
    public ushort A => data.A;
    ...
    private static void CheckByte(int value, string name)
    {
        ...
        {
            throw new ArgumentException($"Value of '{value}' is not valid for '{name}'. '{name}' should be greater than or equal to 0 and less than or equal to 255.");
        }
    }
}