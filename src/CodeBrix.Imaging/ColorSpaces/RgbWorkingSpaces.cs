...
using CodeBrix.Imaging.ColorSpaces.Companding;
using CodeBrix.Imaging.ColorSpaces.Conversion;

// ReSharper disable InconsistentNaming
namespace CodeBrix.Imaging.ColorSpaces; //Was previously: namespace SixLabors.ImageSharp.ColorSpaces;
