...
using CodeBrix.Imaging.Infrastructure;
...
internal static partial class Guard
{
    ...
    {
        if (value >= max) ThrowHelper.ThrowArgumentOutOfRangeExceptionForMustBeLessThan(value, max, parameterName);
    }
    ...
    {
        if (value <= min) ThrowHelper.ThrowArgumentOutOfRangeExceptionForMustBeGreaterThan(value, min, parameterName);
    }
