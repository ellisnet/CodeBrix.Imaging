...
public abstract partial class Image
{
    ...
    /// <param name="width">The width of the memory image.</param>
    /// <param name="height">The height of the memory image.</param>
    /// <param name="expectedFormat">The expected format of the memory image.</param>
    /// <exception cref="ArgumentNullException">The configuration is null.</exception>
    /// <returns>An <see cref="Image{TPixel}"/> instance.</returns>
    public static Image<TPixel> WrapMemory<TPixel>(
        Configuration configuration,
        ...
        where TPixel : unmanaged, IPixel<TPixel>
        => WrapMemory(configuration, pixelMemory, width, height, new ImageMetadata(expectedFormat));
    ...
    public static Image<TPixel> WrapMemory<TPixel>(
        ...
        IImageFormat expectedFormat)
        where TPixel : unmanaged, IPixel<TPixel>
        => WrapMemory(Configuration.Default, pixelMemory, width, height, expectedFormat);
    ...
    public static Image<TPixel> WrapMemory<TPixel>(
        ...
        IImageFormat expectedFormat)
        where TPixel : unmanaged, IPixel<TPixel>
        => WrapMemory(configuration, pixelMemoryOwner, width, height, new ImageMetadata(expectedFormat));
    ...
    public static Image<TPixel> WrapMemory<TPixel>(
        ...
        IImageFormat expectedFormat)
        where TPixel : unmanaged, IPixel<TPixel>
        => WrapMemory(Configuration.Default, pixelMemoryOwner, width, height, expectedFormat);
    ...
    public static Image<TPixel> WrapMemory<TPixel>(
        ...
        IImageFormat expectedFormat)
        where TPixel : unmanaged, IPixel<TPixel>
        => WrapMemory<TPixel>(configuration, byteMemory, width, height, new ImageMetadata(expectedFormat));
    ...
    public static Image<TPixel> WrapMemory<TPixel>(
        ...
        IImageFormat expectedFormat)
        where TPixel : unmanaged, IPixel<TPixel>
        => WrapMemory<TPixel>(Configuration.Default, byteMemory, width, height, expectedFormat);
    ...
    public static Image<TPixel> WrapMemory<TPixel>(
        ...
        IImageFormat expectedFormat)
        where TPixel : unmanaged, IPixel<TPixel>
        => WrapMemory<TPixel>(configuration, byteMemoryOwner, width, height, new ImageMetadata(expectedFormat));
    ...
    public static Image<TPixel> WrapMemory<TPixel>(
        ...
        IImageFormat expectedFormat)
        where TPixel : unmanaged, IPixel<TPixel>
        => WrapMemory<TPixel>(Configuration.Default, byteMemoryOwner, width, height, expectedFormat);
    ...
    public static unsafe Image<TPixel> WrapMemory<TPixel>(
        ...
        IImageFormat expectedFormat)
        where TPixel : unmanaged, IPixel<TPixel>
        => WrapMemory<TPixel>(configuration, pointer, width, height, new ImageMetadata(expectedFormat));
    ...
    public static unsafe Image<TPixel> WrapMemory<TPixel>(
        ...
        IImageFormat expectedFormat)
        where TPixel : unmanaged, IPixel<TPixel>
        => WrapMemory<TPixel>(Configuration.Default, pointer, width, height, expectedFormat);
}