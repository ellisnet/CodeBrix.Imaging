...
/// </summary>
internal struct RgbToYCbCrConverterLutSafe : IRgbToYCbCrConverterLut
{
    /// <summary>
    ...
    {
        RgbToYCbCrConverterLutSafe tables = default;

        tables.YRTable = new int[256];
        tables.YGTable = new int[256];
        tables.YBTable = new int[256];
        tables.CbRTable = new int[256];
        tables.CbGTable = new int[256];
        tables.CbBTable = new int[256];
        tables.CrGTable = new int[256];
        tables.CrBTable = new int[256];
