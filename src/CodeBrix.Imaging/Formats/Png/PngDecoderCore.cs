...
using CodeBrix.Imaging.Compression.Zlib;
using CodeBrix.Imaging.Formats.Png.Chunks;
using CodeBrix.Imaging.Formats.Png.Filters;
    ...
    public IImageInfo Identify(BufferedReadStream stream, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            return new ImageInfo(
                new PixelTypeInfo(this.CalculateBitsPerPixel()), 
                this.header.Width, 
                this.header.Height, 
                metadata,
                PngFormat.Instance);
