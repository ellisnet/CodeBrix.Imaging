...
public class ImageFormatManager
{
    ...
    public IImageDecoder FindDecoder(IImageFormat format)
    {
        ...
        if (format is UnknownImageFormat)
        {
            throw new NotSupportedException(
                "An image decoder cannot be provided for the 'UnknownImageFormat'. " +
                "The image format could not be determined when the image was loaded or created. " +
    ...
    public IImageEncoder FindEncoder(IImageFormat format)
    {
        ...
        {
            throw new NotSupportedException(
                "An image encoder cannot be provided for the 'UnknownImageFormat'. " +
                "The image format could not be determined when the image was loaded or created. " +
                "Please specify the desired output format explicitly when saving the image " +
    ...
    /// <summary>
    /// For the specified encoder find the associated <see cref="IImageFormat"/>.
    /// </summary>
    /// <param name="encoder">The encoder to find the format for.</param>
    /// <returns>The <see cref="IImageFormat"/> if found otherwise null.</returns>
