...
using System.IO;
using CodeBrix.Imaging.Formats.Webp.Lossy;
using CodeBrix.Imaging.Metadata.Profiles.Exif;
using CodeBrix.Imaging.Metadata.Profiles.Xmp;

namespace CodeBrix.Imaging.Formats.Webp.BitWriter; //Was previously: namespace SixLabors.ImageSharp.Formats.Webp.BitWriter;
