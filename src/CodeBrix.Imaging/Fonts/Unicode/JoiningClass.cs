...
public readonly struct JoiningClass
{
    ...
    {
        var category = CodePoint.GetGeneralCategory(codePoint);
        var value = UnicodeData.GetJoiningClass((uint)codePoint.Value);
        JoiningType = GetJoiningType(codePoint, value, category);
        JoiningGroup = (JoiningGroup)((value >> 16) & 0xFF);
    }
