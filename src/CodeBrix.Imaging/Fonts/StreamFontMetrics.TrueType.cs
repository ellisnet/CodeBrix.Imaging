...
using CodeBrix.Imaging.Fonts.Tables.General.Kern;
using CodeBrix.Imaging.Fonts.Tables.General.Name;
using CodeBrix.Imaging.Fonts.Tables.General.Post;
using CodeBrix.Imaging.Fonts.Tables.TrueType;
using CodeBrix.Imaging.Fonts.Tables.TrueType.Glyphs;
using CodeBrix.Imaging.Fonts.Tables.TrueType.Hinting;
...
internal partial class StreamFontMetrics
{
    ...
    /// <summary>
    /// Creates a TrueType glyph metrics with a specific color (for COLRv1).
    /// </summary>
    private TrueTypeGlyphMetrics CreateTrueTypeGlyphMetricsWithColor(
        CodePoint codePoint,
        ushort glyphId,
        GlyphType glyphType,
        GlyphColor color)
