...
///     The MarkArray table contains a count of the number of MarkRecords(markCount) and an array of those
///     records(markRecords).
...
internal class MarkArrayTable
{
    ...
    public MarkArrayTable(BigEndianBinaryReader reader, long offset)
    {
        ...
        for (var i = 0; i < markCount; i++) MarkRecords[i] = new MarkRecord(reader, offset);
    }
