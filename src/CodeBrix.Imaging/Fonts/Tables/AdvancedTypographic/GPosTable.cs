...
using CodeBrix.Imaging.Fonts.Tables.AdvancedTypographic.GPos;
using CodeBrix.Imaging.Fonts.Tables.AdvancedTypographic.Shapers;
...
internal class GPosTable : Table
{
    ...
    private bool TryGetFeatureLookups(
        in Tag stageFeature,
        ScriptClass script,
        out List<(Tag Feature, ushort Index, LookupTable LookupTable)> value)
    {
