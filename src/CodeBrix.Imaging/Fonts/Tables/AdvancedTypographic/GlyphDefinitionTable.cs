...
internal sealed class GlyphDefinitionTable : Table
{
    ...
    public bool TryGetGlyphClass(ushort glyphId, out GlyphClassDef glyphClass)
    {
        glyphClass = default;
    ...
    public bool TryGetMarkAttachmentClass(ushort glyphId, out GlyphClassDef markAttachmentClass)
    {
