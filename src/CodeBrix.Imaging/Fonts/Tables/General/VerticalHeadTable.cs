...
namespace CodeBrix.Imaging.Fonts.Tables.General;
...
internal sealed class VerticalHeadTable : Table
{
    ...
    public static VerticalHeadTable Load(BigEndianBinaryReader reader)
    {
        ...
        var vertTypoAscender = reader.ReadInt16();
        var vertTypoDescender = reader.ReadInt16();
        var vertTypoLineGap = reader.ReadInt16();
        var advanceHeightMax = reader.ReadInt16();
        var minTopSideBearing = reader.ReadInt16();
        var minBottomSideBearing = reader.ReadInt16();
        var yMaxExtent = reader.ReadInt16();
        ...
        var numOfLongVerMetrics = reader.ReadUInt16();
