...
internal class TripleEncodingTable
{
    ...
    public TripleEncodingRecord this[int i] => records[i];
    ...
    private void BuildTable()
    {
        ...
        // 8                                           1024           -
        // 9                                           1024           +
        BuildRecords(2, 0, 8, Array.Empty<ushort>(), new ushort[] { 0, 256, 512, 768, 1024 });
        ...
        // 18                                1024              -
        // 19                                1024              +
        BuildRecords(2, 8, 0, new ushort[] { 0, 256, 512, 768, 1024 }, Array.Empty<ushort>());
        ...
        // 34                                          49      -      +
        // 35                                          49      +      +
        BuildRecords(2, 4, 4, new ushort[] { 1 }, new ushort[] { 1, 17, 33, 49 });
        ...
        // 50                                          49      -      +
        // 51                                          49      +      +
        BuildRecords(2, 4, 4, new ushort[] { 17 }, new ushort[] { 1, 17, 33, 49 });
        ...
        // 66                                          49      -      +
        // 67                                          49      +      +
        BuildRecords(2, 4, 4, new ushort[] { 33 }, new ushort[] { 1, 17, 33, 49 });
        ...
        // 82                                          49      -     +
        // 83                                          49      +     +
        BuildRecords(2, 4, 4, new ushort[] { 49 }, new ushort[] { 1, 17, 33, 49 });
        ...
        // 94                                         513      -     +
        // 95                                         513      +     +
        BuildRecords(3, 8, 8, new ushort[] { 1 }, new ushort[] { 1, 257, 513 });
        ...
        // 106                                         513     -      +
        // 107                                         513     +      +
        BuildRecords(3, 8, 8, new ushort[] { 257 }, new ushort[] { 1, 257, 513 });
        ...
        // 118                                         513     -      +
        // 119                                         513     +      +
        BuildRecords(3, 8, 8, new ushort[] { 513 }, new ushort[] { 1, 257, 513 });
        ...
        // 122                                                 -      +
        // 123                                                 +      +
        BuildRecords(4, 12, 12, new ushort[] { 0 }, new ushort[] { 0 });
        ...
        // 126                                                 -      +
        // 127                                                 +      +
        BuildRecords(5, 16, 16, new ushort[] { 0 }, new ushort[] { 0 });
    }
