...
public sealed class Font
{
    ...
    /// <summary>
    ///     Gets a value indicating whether this <see cref="Font" /> is a color font.
    ///     Color fonts contain COLR/CPAL tables that define multi-colored glyphs.
    /// </summary>
    public bool IsColorFont => FontMetrics.IsColorFont;

    /// <summary>
    ///     Gets the color font format used by this <see cref="Font" />.
    ///     Returns <see cref="ColorFontFormat.None"/> for fonts without color glyph data.
    /// </summary>
    public ColorFontFormat ColorFormat => FontMetrics.ColorFontFormat;
