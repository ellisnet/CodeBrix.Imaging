...
------------------------------------------------------------------
  AGENT-README.txt
      CodeBrix.Imaging.ApacheLicenseForever — fully managed 2D image
      processing, font handling and text rendering for .NET: load, save and
      convert BMP/GIF/JPEG/PBM/PNG/TGA/TIFF/WebP, resize and transform,
      filter, quantize, composite, read and write metadata, and draw text.
